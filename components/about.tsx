...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"회사명","period":"2020 - 현재","description":"직무 및 역할"},{"icon":"graduation","title":"단국대학교","period":"2019 - 현재","description":"부동산학과"},{"icon":"award","title":"자격증/수상","period":"2022 - 공인중개사","description":"설명을 입력하세요"},{"icon":"briefcase","title":"목표","period":"2025 - 감정평가사 1차합격하기","description":""}],
